...
import { on, select, selectAll, getHeight, setStyle, getData, scrollTop, getTopPosition, addClass } from 'lib/dom'
  ...
  methods: {
    ...
    initEvents () {
      ...
      this.instance.on('staticClick', (e, pointer, cellEl, cellIndex) => {
        if (typeof cellEl === 'undefined' || typeof cellIndex === 'undefined') return
